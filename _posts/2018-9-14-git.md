...
---
    ...
    Esta é a segunda versão do artigo "Tudo que você queria saber sobre GIT", escrita inicialmente em 2015. Foram realizadas várias modificações no artigo, dentre elas removemos o uso do `cloud9` e adicionamos como realizar operações no GIT com o Visual Studio Code.
